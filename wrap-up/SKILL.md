...
description: Use when user says "wrap up", "close session", "end session",
  ...
  end-of-session checklist for memory, and self-improvement
---

based on https://www.reddit.com/r/Anthropic/comments/1rq0m7r/selfimprovement_loop_my_favorite_claude_code_skill/
